...
{
    public class DataAccessCars : IDataAccessCars
    {
        static String connectionStringCarDealerShipDB = String.Empty;
        private readonly IConfiguration _config;
        string errorMessage = String.Empty;

        public DataAccessCars()
        {

        }
        public DataAccessCars(IConfiguration config)
        {
            _config = config;
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionStringCarDealerShipDB))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("[dbo].[spCarsUpdateOrInsert]", connection))
                    {
                        ...
                        //command.Parameters.AddWithValue("@Sold", insertedCar.Sold);
