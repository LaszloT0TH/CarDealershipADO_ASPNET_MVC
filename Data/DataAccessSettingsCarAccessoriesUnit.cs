...
{
    public partial class DataAccessCarAccessoriesUnit : IDataAccessCarAccessoriesUnit
    {
        static String connectionStringCarDealerShipDB = String.Empty;
        private readonly IConfiguration _config;
        string errorMessage = String.Empty;

        public DataAccessCarAccessoriesUnit()
        {

        }
        public DataAccessCarAccessoriesUnit(IConfiguration config)
        {
            _config = config;
