...
{
    public partial class DataAccessSpokenLangues : IDataAccessSpokenLangues
    {
        static String connectionStringCarDealerShipDB = String.Empty;
        private readonly IConfiguration _config;
        string errorMessage = String.Empty;

        public DataAccessSpokenLangues()
        {

        }
        public DataAccessSpokenLangues(IConfiguration config)
        {
            _config = config;
