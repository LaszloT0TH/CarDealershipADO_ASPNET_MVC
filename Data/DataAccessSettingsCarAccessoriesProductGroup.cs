...
{
    public partial class DataAccessCarAccessoriesProductGroup : IDataAccessCarAccessoriesProductGroup
    {
        static String connectionStringCarDealerShipDB = String.Empty;
        private readonly IConfiguration _config;
        string errorMessage = String.Empty;

        public DataAccessCarAccessoriesProductGroup()
        {

        }
        public DataAccessCarAccessoriesProductGroup(IConfiguration config)
        {
            _config = config;
