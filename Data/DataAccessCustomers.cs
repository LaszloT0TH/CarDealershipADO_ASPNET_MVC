...
{
    public partial class DataAccessCustomer : IDataAccessCustomer
    {
        ...
        public DataAccessCustomer(IConfiguration config)
        {
            _config = config;
        ...
        public async Task CustomersInsert(CustomerInsertModel insertedCustomer)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionStringCarDealerShipDB))
