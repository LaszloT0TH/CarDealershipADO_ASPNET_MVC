...
{
    public class DataAccess_HelpQuery : IDataAccess_HelpQuery
    {
        static String connectionStringCarDealerShipDB = String.Empty;
        private readonly IConfiguration _config;
        string errorMessage = String.Empty;

        public DataAccess_HelpQuery()
        {

        }
        public DataAccess_HelpQuery(IConfiguration config)
        {
            _config = config;
